...
const es = {
  tour: [
    { tab: null, icono: "◈", t: "Bienvenido a TradeSafe",
  ...
  temas: [
    ...
    { id: "problemas", icono: "⚖", t: "Si algo sale mal", pasos: [
...
const en = {
  tour: [
    { tab: null, icono: "◈", t: "Welcome to TradeSafe",
  ...
  temas: [
    ...
    { id: "problemas", icono: "⚖", t: "If something goes wrong", pasos: [
