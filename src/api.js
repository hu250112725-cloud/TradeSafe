...
export async function resortear(id, reason) { await call(`/giveaways/${id}/resortear`, { method: "POST", body: { reason } }); await sync(); }
export async function recalcularSorteo(id) { await call(`/giveaways/${id}/recalcular`, { method: "POST" }); await sync(); }
